...
userController.checkIsFollowing = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { data, error } = yield supabase_1.default
        .from("relationships")
...
userController.toggleFollow = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
userController.upsertAvatar = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
      if (!req.file) {
      ...
      const avatarData = yield supabase_1.default.storage
        ...
        .upload(req.body.path, fileContent, {
          ...
          upsert: true,
          contentType:
            (_a = req.file) === null || _a === void 0 ? void 0 : _a.mimetype,
        });
      if (avatarData.data) {
...
userController.getFollowCount = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
